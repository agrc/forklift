        ...
        def fake_server(value):
            ...
            if value.endswith("arcgis/admin/services"):
                return {
                    ...
                    "folders": ["App1"],
                    "services": [
                        {"folderName": "/", "serviceName": "Service1", "type": "MapServer", "description": ""},
                        {"folderName": "/", "serviceName": "Service2", "type": "GPServer", "description": ""},
                    ],
                }
                ...
                return {
                    ...
                    "services": [
                        {"folderName": "App1", "serviceName": "Service3", "type": "MapServer", "description": ""},
                        {"folderName": "App1", "serviceName": "Service4", "type": "GPServer", "description": ""},
                    ],
                }
