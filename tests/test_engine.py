        ...
        with open(path) as config:
            ...
            self.assertEqual(
                config_dict,
                {
                    ...
                    "warehouse": "c:\\forklift\\warehouse",
...
class TestPackingSlip(unittest.TestCase):
    def test_format_ticket_for_report(self):
        ...
        bad_crate = {
            "name": "Bad-Crate",
            "result": Crate.UNHANDLED_EXCEPTION,
            "crate_message": "This thing blew up.",
            "message_level": "error",
        }
        warn_crate = {
            "name": "Warn-Crate",
            "result": Crate.WARNING,
            "crate_message": "This thing almost blew up.",
...
class TestShipData(CleanUpAlternativeConfig):
    sample_slip = """[
  {
    ...
    def test_ship_only_ships_if_only_slip_found(
        self, listdir, copy_data, config_prop, packing_slip, exists, socket, generate_mock
    ):
