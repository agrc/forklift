...
class TestForklift(unittest.TestCase):
    ...
    def test_process_pallets_mixed_bag(self):
        ...
        forklift.process_pallets([pallet1, pallet2, pallet3])
    ...
    def test_process_pallets_returns_reports(self):
        reports_pallet = self.PalletMock('reports')
        reports_pallet.get_report.return_value = 'hello'

        result = forklift.process_pallets([reports_pallet, reports_pallet])
